...
Usage (from /home/gitaa/Desktop/LLM_API):
    python3 user_management_auto/wipe_users.py          # dry-run: shows who would be deleted
    python3 user_management_auto/wipe_users.py --confirm  # actually deletes everyone
"""
