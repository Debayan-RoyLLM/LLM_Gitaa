#!/usr/bin/env python3
"""quota_desk.server — HTTP handler and entry point."""
...
from .api import call_litellm, stack_status, list_keys


class Handler(BaseHTTPRequestHandler):
    """Thin HTTP router that delegates to api.py / config."""

    server_version = "QuotaDesk/1.0"
...
def main():
    ...
    print("Quota Desk on http://" + args.host + ":" + str(args.port))
